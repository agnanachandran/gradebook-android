...
public class CoursesDBAdapter extends DBAdapter {
     ...
     * @param courseUnits units of the course
     * @param notes notes of the course
     * @param termRef id reference to the term
     * @return rowId or -1 if failed
     */
    public long createCourse(String courseTitle, String courseCode, double courseUnits, String notes, int termRef){
    ...
    public Cursor getAllCourses() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] { ROW_ID,
        		COURSE_TITLE, COURSE_CODE, COURSE_UNITS, COURSE_NOTES, TERM_REFERENCE }, null, null, null, null, null);
    }
    ...
    public Cursor getCoursesOfTerm(long termRefID) throws SQLException {
        ...
        mDb.query(true, DATABASE_TABLE, new String[] { ROW_ID,
        		COURSE_TITLE, COURSE_CODE, COURSE_UNITS, COURSE_NOTES, TERM_REFERENCE }, TERM_REFERENCE + "=" + termRefID, null, null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
        return mCursor;
    ...
    public Cursor getCourse(long rowId) throws SQLException {
        ...
        mDb.query(true, DATABASE_TABLE, new String[] { ROW_ID,
        		COURSE_TITLE, COURSE_CODE, COURSE_UNITS, COURSE_NOTES, TERM_REFERENCE }, ROW_ID + "=" + rowId, null, null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
        return mCursor;
     ...
     */
    public boolean updateCourse(long rowId, String courseTitle, String courseCode, double courseUnits, String notes, int termRef){
