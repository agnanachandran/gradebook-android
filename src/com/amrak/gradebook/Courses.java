...
public class Courses extends Activity {
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		CourseData courseSelected = (CourseData) courseslistAdapter
	...
	public boolean onContextItemSelected(MenuItem menuItem) {
		...
		case CONTEXT_EDIT:
			Intent iAddCourse = new Intent("com.amrak.gradebook.ADDCOURSE");
			iAddCourse.putExtra("refID_Term", refIDGet_Term);
			iAddCourse.putExtra("idEdit_Item",
					refIDPass_Course[contextSelection]);
							...
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									String titleDelete = cDelete.getString(cDelete
											.getColumnIndex("courseTitle"));
									coursesDB
											.deleteCourse(refIDPass_Course[contextSelection]);
									coursesDB.close();
		...
		if (c.moveToFirst()) {
			do {
				...
				courses.add(new CourseData(c.getInt(c.getColumnIndex("_id")), c
						...
						.getColumnIndex("notes")), c.getInt(c
