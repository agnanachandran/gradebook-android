...
public class Categories extends Activity{
	...
	public boolean onContextItemSelected (MenuItem menuItem){
		...
		case CONTEXT_DELETE:
		    ...
		    .setMessage("Are you sure you want to delete \"" + titleDelete + "\" and ALL Evaluations within it?")
		    .setPositiveButton("Delete", new DialogInterface.OnClickListener() {
				...
				public void onClick(DialogInterface dialog, int which) {
					...
					Toast toast = Toast.makeText(context, titleDelete + " and all Evaluations within it was deleted successfully.", Toast.LENGTH_SHORT);
					try {
						//center toast
