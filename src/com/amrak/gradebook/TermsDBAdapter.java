...
public class TermsDBAdapter extends DBAdapter {
    ...
    /**
     * Create a term. If the term is successfully created return the new rowId
     * for that term, otherwise return a -1 to indicate failure.
     * 
     * @param termTitle
     *            title of term
     * @param termDateStart
    ...
    public Cursor getAllTerms() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] { ROW_ID, TERM_TITLE, TERM_DATESTART,
                TERM_DATEEND }, null, null, null, null, null);
    }
     ...
     * @throws SQLException
     *             if term could not be found/retrieved
     */
    public Cursor getTerm(long rowId) throws SQLException {

        Cursor mCursor =

        mDb.query(true, DATABASE_TABLE, new String[] { ROW_ID, TERM_TITLE, TERM_DATESTART,
                TERM_DATEEND }, ROW_ID + "=" + rowId, null, null, null, null, null);
        if (mCursor != null)
        {
            mCursor.moveToFirst();
        }
