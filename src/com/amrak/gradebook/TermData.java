...
public class TermData {
    ...
    public TermData(int inputTermID, String inputTitle, String inputDateStart, String inputDateEnd,
    ...
    public double calcMarkFromDatabase(int termID) {
        ...
        else
        {
            if (c.moveToFirst())
            {
                do
                {
                    double weightFraction = c.getDouble(c.getColumnIndex("courseUnits"))
                            / totalWeight;
                    courseData = new CourseData(c.getInt(c.getColumnIndex("_id")), c.getString(c
                            .getColumnIndex("courseTitle")), c.getString(c
                            .getColumnIndex("courseCode")), c.getInt(c
                            .getColumnIndex("courseUnits")),
                            c.getString(c.getColumnIndex("notes")), c.getInt(c
