...
import com.amrak.gradebook.Utils;
import com.amrak.gradebook.adapter.CoursesListAdapter;
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                try
                {
                    ...
                    Class cCategories;
                    cCategories = Class.forName("com.amrak.gradebook.activity.Categories");
