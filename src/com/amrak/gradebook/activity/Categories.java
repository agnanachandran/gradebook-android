...
import com.amrak.gradebook.adapter.CategoriesListAdapter;
...
import com.amrak.gradebook.model.CategoryData;
import com.amrak.gradebook.model.CourseData;
...
public class Categories extends Activity {
        ...
        listView.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                try
                {
                    ...
                    Class cEvaluations;
                    cEvaluations = Class.forName("com.amrak.gradebook.activity.Evaluations");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.addcategory:
                Intent iAddCat = new Intent("com.amrak.gradebook.activity.ADDCAT");
    ...
    public boolean onContextItemSelected(MenuItem menuItem) {
        ...
        {
            case CONTEXT_EDIT:
                Intent iAddCategory = new Intent("com.amrak.gradebook.activity.ADDCAT");
