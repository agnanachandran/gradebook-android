...
public abstract class DBAdapter {
    ...
    // Database Name and Version, Change version if updates through "onUpgrade"
    // method after app release
    ...
    private static final String CREATE_TABLE_COURSE = "CREATE TABLE IF NOT EXISTS courses (_id INTEGER primary key autoincrement, " //$NON-NLS-1$
            + CoursesDBAdapter.COURSE_TITLE
            + " VARCHAR not null," //$NON-NLS-1$
            + CoursesDBAdapter.COURSE_CODE
            + " VARCHAR," //$NON-NLS-1$
            + CoursesDBAdapter.COURSE_UNITS
            + " DECIMAL(10,4),"
            + CoursesDBAdapter.COURSE_NOTES
            + " VARCHAR," + CoursesDBAdapter.TERM_REFERENCE + " INT" //$NON-NLS-1$
            + ");"; //$NON-NLS-1$ //$NON-NLS-2$

    private static final String CREATE_TABLE_CATEGORY = "CREATE TABLE IF NOT EXISTS categories (_id INTEGER primary key autoincrement, " //$NON-NLS-1$
            ...
            + CategoriesDBAdapter.CAT_AVERAGE + " DECIMAL(10,4)" //$NON-NLS-1$
            + ");"; //$NON-NLS-1$ //$NON-NLS-2$

    private static final String CREATE_TABLE_EVALUATION = "CREATE TABLE IF NOT EXISTS evaluations (_id INTEGER primary key autoincrement, " //$NON-NLS-1$
            + EvaluationsDBAdapter.EVAL_TITLE
            + " VARCHAR not null," //$NON-NLS-1$
            + EvaluationsDBAdapter.EVAL_MARK
            + " DECIMAL(10,4)," //$NON-NLS-1$
            + EvaluationsDBAdapter.EVAL_OUTOF
            + " DECIMAL(10,4),"
            + EvaluationsDBAdapter.EVAL_WEIGHT
            + " DECIMAL(10,4),"
            + EvaluationsDBAdapter.EVAL_DATE
            + " DATETIME," + EvaluationsDBAdapter.TERM_REFERENCE + " INT," //$NON-NLS-1$
